...
namespace RoboticCoders.Migrations
{
    ...
    [Migration("20260209235609_AddCompletedAtToStudentLessonProgresses")]
    partial class AddCompletedAtToStudentLessonProgresses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoboticCoders.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RoboticCoders.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoboticCoders.Models.CourseEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RoboticCoders.Models.StudentLessonProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RoboticCoders.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoboticCoders.Models.Lesson", b =>
                {
                    b.HasOne("RoboticCoders.Models.Module", "Module")
                        .WithMany("Lessons")
